"""Helpdesk Agent - FastAPI Application."""
...
app = FastAPI(
    ...
    description="IT helpdesk agent that handles user support requests, troubleshoots common IT issues, automates password resets, manages software installations, and escalates complex issues with full context to Tier 2 support.",
    version="1.0.0",
    docs_url="/docs",
    redoc_url="/redoc",
    lifespan=lifespan,
